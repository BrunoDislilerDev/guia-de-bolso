...
export const GUIA_GUIDES = [
  {
    ...
    relatedGuides: [
      ...
      { href: "/guia/hospedagem-imbituba", label: "Hospedagem" },
    ],
  ...
  },
  {
    ...
    intro:
      "Imbituba e o litoral sul catarinense são referência em surf no Brasil. Este guia orienta picos clássicos, segurança e como montar o dia usando lugares e rotas do app.",
    sections: [
      {
  ...
  {
    slug: "hospedagem-imbituba",
    title: "Onde se hospedar em Imbituba",
    metaTitle: "Hospedagem em Imbituba — pousadas e regiões",
    metaDescription:
      "Centro, Praia da Vila, Ibiraquera e Rosa: como escolher hospedagem em Imbituba. Lista no Guia de Bolso Imbituba.",
    intro:
      "A escolha da hospedagem define deslocamentos e o ritmo da viagem. Imbituba oferece desde pousadas no centro até vilas mais afastadas perto da natureza — veja como decidir.",
    sections: [
      {
        heading: "Centro e Praia da Vila",
        paragraphs: [
          "Melhor para quem quer serviços, restaurantes e praia urbana a pé ou de carro curto. Bom para primeira visita e viagens curtas.",
        ],
      },
      {
        heading: "Ibiraquera e arredores",
        paragraphs: [
          "Ambiente mais tranquilo, lagoa e mar — popular para estadias mais longas, kitesurf e famílias que buscam calma.",
        ],
      },
      {
        heading: "Base para a Praia do Rosa",
        paragraphs: [
          "Muitos visitantes se hospedam em Imbituba e fazem bate-volta ao Rosa. Planeje trânsito em alta temporada.",
        ],
        links: [{ href: "/guia/praia-do-rosa", label: "Guia Praia do Rosa" }],
      },
      {
        heading: "Encontrar pousadas no guia",
        paragraphs: [
          "Filtre a categoria Hospedagem para ver opções com fotos, contato e avaliações aprovadas.",
        ],
        links: [{ href: getCategoriaHref("Hospedagem"), label: "Hospedagem no guia" }],
      },
    ],
    relatedGuides: [
      { href: "/guia/roteiro-3-dias-imbituba", label: "Roteiro 3 dias" },
    ...
    ctaPrimary: { href: getCategoriaHref("Hospedagem"), label: "Ver hospedagem" },
    ctaSecondary: { href: "/categorias", label: "Todas categorias" },
    listPlacesCategory: "Hospedagem",
    listPlacesLimit: 8,
