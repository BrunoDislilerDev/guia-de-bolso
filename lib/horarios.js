 ...
 * @param {boolean} [mostrar_horarios] - Quando o 2º argumento é passado, retorna `null` se não for `true` ou sem horários (badges).
 * @returns {StatusFuncionamento|null}
 */
export function getStatusFuncionamento(horarios, mostrar_horarios) {
