...
export const LANDING_HERO = {
  ...
  line2: "Imbituba.",
  subtitle:
    "Praias, Praia do Rosa, gastronomia e rotas curadas — o app de turismo local para visitar a cidade com confiança.",
...
export const LANDING_BUSINESS_BENEFITS = [
  ...
  },
  {
    ...
    body: "Cadastro no guia oficial da cidade, sem custo inicial.",
  },
];
